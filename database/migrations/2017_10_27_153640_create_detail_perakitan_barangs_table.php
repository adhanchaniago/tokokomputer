...
class CreateDetailPerakitanBarangsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('detail_perakitan_barangs', function(Blueprint $table) {
            ...
            // $table->foreign('no_baris_paket')->references('no_baris')->on("detail_perakitan_pakets")->onDelete('cascade');
    ...
    {
        Schema::drop('detail_perakitan_barangs');
    }
}
