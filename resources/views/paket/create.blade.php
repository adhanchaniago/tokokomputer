            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        @endif
                         {!! Form::open(['url' => '/paket', 'method' => 'post', 'class' => 'form-horizontal', 'files' => true]) !!}
                        <div class="row">
                                ...
                                <div  class="col-md-4">
                                    <textarea class="form-control" rows="3" style="resize: none;" name="detail" required></textarea>
                                </div>
                        </div>
                                <hr>
                                      ...
                                      <table class="table">
                                        ...
                                        <tfoot>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="number" class='form-control' required name="total_harga_asli" id="grandTot">
                                                </td>
                                                <td></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="number" class='form-control' required name="total_harga_jual" id="totaljual">
                                                </td>
                                            </tr>
    ...
    $('#tambah').click(function(){
        ...
        var baris = "<tr  id='no"+itung+"'>"+
                                                "<td>"+
                                                    ...
                                                    "</select>"+
                                                "</td>"+
                                               "<td><input type='number' min='0' class='form-control' name='total[]' id='total"+itung+"' ></td>"+
